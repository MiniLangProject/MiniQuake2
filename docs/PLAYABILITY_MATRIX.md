...
| P12 | Release/package/device acceptance | prior full Release/package matrix plus current local RTX-5080 fullscreen restart, native default-device cinematic and 20,000-frame/40,740-packet retail soak at 43.89 fps | PARTIAL | fresh RC matrix/package plus second-host GPU/audio, hot-unplug and manual latency |
