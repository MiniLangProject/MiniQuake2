...
| P12 | Release/package/device acceptance | current 192-program Release matrix, Debug product graph, byte-reproducible/extracted-smoked packages, RTX-5080 fullscreen restart, native default-device cinematic, 100,000-frame/212,822-packet retail session soak with zero rejects or pending sounds, and the 47-map/500-frame-per-map Release FPS matrix | PARTIAL (local RC complete) | second-host GPU/audio, hot-unplug, controller/manual latency and compatible-host original process |
