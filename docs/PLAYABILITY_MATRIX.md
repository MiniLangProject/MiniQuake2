...
| P05 | Stock monster frame sequencing | attack/ranged/melee with exact attack movement and mechanical sounds, 63 pain, 43 death, dodge, primary locomotion, complete stock sound precache, class corpse bounds, physical gibs and staged Supertank destruction; live MZ2 and Parasite beam chains | PASS (attacks, primary moves and death terminals) | secondary fidgets, sight/search choices and reaction/death movement differential |
...
| P12 | Release/package/device acceptance | current 149-program Release matrix, Debug product graph, byte-reproducible/extracted-smoked packages, RTX-5080 fullscreen restart, native default-device cinematic and 20,000-frame/40,740-packet retail soak at 43.89 fps | PARTIAL (local RC complete) | second-host GPU/audio, hot-unplug, controller/manual latency and compatible-host original process |
