...
| P02 | Player move, look and all stock weapons | weapon/ballistics goldens plus 3.19 temp-entity, layered muzzle-sound, monster-flash, trail/teleport/Steam/Widow/Nuke particle-family and fixed-pool lifecycle goldens | PASS (mechanics/client protocol feedback) | paired original view-model/recoil/pixel capture |
