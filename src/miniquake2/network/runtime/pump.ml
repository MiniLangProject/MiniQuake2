...
/// @param socket socket value consumed by this operation.
/// @param now now value consumed by this operation.
/// @param maximumPackets maximumPackets value consumed by this operation.
...
/// @param integrated integrated value consumed by this operation.
...
/// Pump pair.
/// @param clientRuntime clientRuntime value consumed by this operation.
/// @param serverRuntime serverRuntime value consumed by this operation.
/// @param clientSocket clientSocket value consumed by this operation.
/// @param serverSocket serverSocket value consumed by this operation.
/// @param now now value consumed by this operation.
/// @param maximumPackets maximumPackets value consumed by this operation.
