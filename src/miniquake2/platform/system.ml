...
/// Store clock data.
struct Clock
  /// Stores the frequency value associated with clock.
  frequency
  /// Stores the origin value associated with clock.
  origin
end struct
...
/// @param millisecondsToWait millisecondsToWait value consumed by this operation.
